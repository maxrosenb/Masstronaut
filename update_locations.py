...
import random, sys, timeit, os, psutil
...
def print_memory_usage():
	...
	print("memory used (in bytes): ", process.memory_info().rss)
...
mean_time_per_coord = (1000000 * t / (size * iters))
print("Mean time per coordinate: " + str(mean_time_per_coord) + "us")
